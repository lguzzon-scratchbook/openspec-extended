...
[![Version](https://img.shields.io/badge/version-v1.0.3-orange.svg?style=flat-square)](https://github.com/amauryconstant/openspec-extended)
...
```bash
VERSION=v1.0.3 curl -sSL https://raw.githubusercontent.com/amauryconstant/openspec-extended/main/install.sh | bash
```
